...
void Core::NeuronIntegrate(std::vector<int> axon_list, std::vector<std::vector<int>> weight_list, int neuron_index, int axon_index)
{
    this->NB->Integrate(axon_list, weight_list, neuron_index, axon_index);
}
