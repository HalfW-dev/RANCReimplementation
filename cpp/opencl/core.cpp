...
void Core::NeuronIntegrate(std::vector<int> axon_list, std::vector<std::vector<int>> weight_list, std::vector<int>& neuron_list)
{
    this->NB->Integrate(axon_list, weight_list, neuron_list);
}

void Core::NeuronFire(std::vector<int>& neuron_list, int threshold, int reset_value)
{
    this->NB->Fire(neuron_list, threshold, reset_value);
};
